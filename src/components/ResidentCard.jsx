 ...
 console.log(resident)
  ...
  return (
    <div className="resident__card">
      {pending ? (<>
          <Skeleton height={350} /> 
          <Skeleton height={20} style={{ marginTop: '10px', padding: '10px' }} /> 
          <Skeleton height={30} style={{ marginTop: '10px', padding: '10px' }} /> 
          <Skeleton height={20} style={{ marginTop: '10px', padding: '10px' }} />
          <Skeleton height={20} style={{ marginTop: '10px', padding: '10px' }} />
          <Skeleton height={20} style={{ marginTop: '10px', padding: '10px' }} /> 
          </>):(<> 
        ...
        <div className="resident__card__body">
          <h3>{resident?.name}</h3>
          <ul>
            <li>Specie: <br /> <span className="bold">{resident?.species}</span> </li>
            <li>Origin: <br /> <span className="bold">{resident?.origin?.name}</span> </li> 
          </ul>
          <div style={styleFooter} className="resident__card__footer">
            <p  className="resident__card__copy">Appears in {countEpisodes} {textEpisodes}</p> 
          </div>
        </div>
      </>)}
    </div>
